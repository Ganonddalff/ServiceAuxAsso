...
namespace AssoFlex.Models
{
    public class Paiement
    {
        ...
        //
        // public Paiement(IConfiguration configuration)
        // {
        //     this.Configuration = configuration;
        // }
        //
        // public string RunPayment(decimal amount, Commande datOrder, Utilisateur user)
        // {
        ...
        //
        //     var lineItems = new lineItemType[datOrder.LignesDeCommande.Count];
        //     int count = 0;
        //     foreach (var item in datOrder.LignesDeCommande)
        //     {
        //         //line items to process
        //         lineItems[count] = new lineItemType { itemId = (item.ProduitId).ToString(),
        //             name = item.ProduitNom, quantity = item.Quantite, unitPrice = item.MontantUnitaire };
        //         count++;
        //     }
        //
