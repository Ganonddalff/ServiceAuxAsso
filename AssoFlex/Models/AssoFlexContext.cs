...
namespace AssoFlex.Models
{
    public class AssoFlexContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("server=localhost;user id=root;password=Knph-Nmas27;database=Assoflex"); //   <===== Paul tu dois mettre tes identifiants mySQL ici !
            }
            else
            {
                IConfiguration configuration = new ConfigurationBuilder()
                    ...
                    .Build();
                optionsBuilder.UseMySql("server=localhost;user id=root;password=Knph-Nmas27;database=Assoflex");  //  <=== Et ici aussi !
            }
        }
